export default function GhostIcon({ className = '', size = 100 }) {
    ...
    return (
        ...
        >
            ...
            <g transform="translate(46, 28) scale(0.75)">
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
            ...
            <circle cx="49" cy="44" r="2" strokeWidth="2.5" stroke="rgba(167, 139, 250, 0.9)" fill="rgba(167, 139, 250, 0.5)" />
