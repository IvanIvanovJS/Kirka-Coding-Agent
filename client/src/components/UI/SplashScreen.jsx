...
export default function SplashScreen({ onFinished }) {
	...
	return (
		<div className={`${styles.splashScreen} ${isFinishing ? styles.fadeOut : ''}`}>
			<div className={styles.content}>
				...
				>
					...
					<g className={styles.eyesElements}>
						<circle cx="34" cy="22.5" r="1.2" fill="rgb(26, 11, 46)" opacity="0.7" />
						<circle cx="42" cy="22.5" r="1.1" fill="rgb(26, 11, 46)" opacity="0.7" />
					</g>

					<g className={styles.smileElements}>
						<path
					...
					<g className={styles.pickaxe} transform="translate(46, 28) scale(0.90)">
						<path
							fillRule="evenodd"
							clipRule="evenodd"
				...
				<div className={styles.textContainer}>
					<span className={styles.text}>Assembling agent</span>
